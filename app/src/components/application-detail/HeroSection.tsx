...
export default function HeroSection({
  ...
  return (
    <section
      ...
      aria-label={`${industry} Application Hero`}
    >
      {/* Grid overlay */}
      <div
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            >
              ...
              <a href="/solutions/applications" className="hover:text-white/80 transition-colors">Applications</a>
              <ChevronRight className="w-3 h-3 shrink-0" />
          ...
          >
            <div
              ...
              style={{
                boxShadow: "0 0 0 1px rgba(45,122,79,0.5), 0 0 60px rgba(45,122,79,0.25), 0 30px 80px rgba(0,0,0,0.4)",
              }}
            >
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #1a5c38 0%, #0d3a22 40%, #112e1e 100%)",
                }}
              />
