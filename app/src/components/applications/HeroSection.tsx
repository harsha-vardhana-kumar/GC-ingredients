...
const stats = [
  { value: 6, suffix: "", label: "Industry Segments" },
  { value: 2500, suffix: "+", label: "Formulations" },
  { value: 100, suffix: "+", label: "Manufacturers Served" },
  ...
  return (
    <section className="relative bg-[#0d3a22] pt-36 pb-24 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <motion.h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold font-[family-name:var(--font-plus-jakarta)] text-white leading-[1.1] mb-6 max-w-5xl mx-auto" variants={fadeUp(0.1)} initial="hidden" animate="visible">
          Ingredient Solutions Across{" "}
          <span className="text-[#e8650a]">Every Food Category</span>
        </motion.h1>
        <motion.p className="text-lg text-green-200 leading-relaxed max-w-2xl mx-auto mb-10" variants={fadeUp(0.2)} initial="hidden" animate="visible">
          GC Ingredients delivers purpose-built ingredient systems across six major food manufacturing segments — each backed by deep technical expertise and 25+ years of application knowledge.
        </motion.p>
        <motion.div className="flex flex-wrap gap-4 justify-center mb-16" variants={fadeUp(0.3)} initial="hidden" animate="visible">
          <a href="#applications" className="inline-flex items-center gap-2 bg-[#e8650a] hover:bg-[#f07a2a] text-white font-semibold px-7 py-3.5 rounded-xl transition-all hover:-translate-y-0.5 shadow-lg shadow-[#e8650a]/30">
