...
export default function CSRCTASection() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <div className="w-16 h-16 rounded-2xl bg-[#e8650a]/20 flex items-center justify-center">
            <Globe className="w-8 h-8 text-[#e8650a]" />
          </div>
        </motion.div>
        ...
        >
          ...
          <span className="text-[#e8650a]">That Cares</span>
        </motion.h2>
        ...
        <motion.p
          ...
          viewport={{ once: true, margin: "-100px" }}
        >
          When you work with GC Ingredients, you are choosing a partner committed to doing
          business the right way — for people, for the planet, and for food.
        </motion.p>
