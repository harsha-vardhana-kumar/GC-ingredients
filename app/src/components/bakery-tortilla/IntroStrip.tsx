...
import { Wheat, UtensilsCrossed, Settings2 } from "lucide-react";

const items = [
  { icon: Wheat, title: "Bakery Solutions", sub: "Breads, rolls, pastries, cookies" },
  { icon: UtensilsCrossed, title: "Tortilla Solutions", sub: "Flour and corn tortillas, wraps" },
  { icon: Settings2, title: "Custom Blends", sub: "Tailor-made for your exact specs" },
];
