...
import { Microscope, Settings2, ShieldCheck, Headphones } from "lucide-react";

const cards = [
  { icon: Microscope, color: "#1a5c38", title: "Deep Category Expertise", desc: "25+ years specifically in bakery and tortilla ingredient systems." },
  { icon: Settings2, color: "#e8650a", title: "Custom Formulations", desc: "Every blend built to your exact specs, process, and application." },
  { icon: ShieldCheck, color: "#1a5c38", title: "Quality Validated", desc: "In-house QC lab validates every batch before it leaves our facility." },
  { icon: Headphones, color: "#e8650a", title: "Technical Support", desc: "Dedicated food scientists available throughout your development process." },
];

export default function WhyGCIBakery() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div className="text-center mb-14" initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.65 }}>
          ...
          <h2 className="text-4xl lg:text-5xl font-bold font-[family-name:var(--font-plus-jakarta)] text-[#111827] mb-4">
            The Ingredient Partner Bakery <span className="text-[#1a5c38]">Manufacturers Trust</span>
          </h2>
        </motion.div>
