...
export default function MainContent({
  ...
  return (
    <section className="py-20 bg-white" aria-label="Main Content">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <div
              ...
              style={{ boxShadow: "0 20px 60px rgba(26,92,56,0.12), 0 4px 20px rgba(0,0,0,0.06)" }}
            >
              <div
                className="absolute inset-0"
                style={{ background: "linear-gradient(135deg, #eaf5ee 0%, #f5f3ee 50%, #fdf8f0 100%)" }}
              />
              {/* Grid dots */}
              <div
                className="absolute inset-0 opacity-30"
                style={{
                  backgroundImage: "radial-gradient(circle, #1a5c38 1px, transparent 1px)",
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-5">
                ...
                <div className="text-center px-6">
                  ...
                  <div className="text-[#6b7280] text-sm mt-1">Advanced Food Science</div>
                </div>
              </div>
            </div>
          </motion.div>
