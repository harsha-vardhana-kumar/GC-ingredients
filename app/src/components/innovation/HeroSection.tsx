...
const stats = [
  { value: 500, suffix: "+", label: "R&D Trials Annually" },
  { value: 2500, suffix: "+", label: "Formulations Developed" },
  { value: 25, suffix: "+", label: "Years Food Science" },
...
export default function InnovationHeroSection() {
  return (
    <section className="relative bg-[#0d3a22] pt-36 pb-20 overflow-hidden">
      <div className="absolute inset-0 pointer-events-none" style={{ backgroundImage: "radial-gradient(ellipse at 70% 15%, rgba(26,92,56,0.55) 0%, transparent 60%), radial-gradient(ellipse at 10% 90%, rgba(232,101,10,0.1) 0%, transparent 50%)" }} />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <motion.h1 className="text-4xl sm:text-5xl font-bold font-[family-name:var(--font-plus-jakarta)] text-white leading-[1.1] mb-6" variants={fadeUp(0.1)} initial="hidden" animate="visible">
              Where Food Science Meets{" "}
              <span className="text-[#e8650a]">Innovation</span>
            </motion.h1>
            <motion.p className="text-green-200 leading-relaxed mb-8 text-[17px]" variants={fadeUp(0.2)} initial="hidden" animate="visible">
              At GC Ingredients, innovation is not a department — it is how we think. Every formulation we develop is the result of rigorous R&amp;D, deep application knowledge, and a relentless commitment to solving your toughest ingredient challenges.
            </motion.p>
            <motion.div className="flex flex-wrap gap-4 mb-12" variants={fadeUp(0.3)} initial="hidden" animate="visible">
              <a href="#rd-overview" className="inline-flex items-center gap-2 bg-[#e8650a] hover:bg-[#f07a2a] text-white font-semibold px-7 py-3.5 rounded-xl transition-all hover:-translate-y-0.5 shadow-lg shadow-[#e8650a]/30">
                Explore Our R&amp;D <ArrowRight className="w-4 h-4" />
              </a>
            ...
            <div className="flex flex-wrap gap-8 border-t border-white/15 pt-8">
              {stats.map((s, i) => (
                <motion.div key={s.label} variants={fadeUp(0.4 + i * 0.1)} initial="hidden" animate="visible">
                  <div className="text-2xl font-bold font-[family-name:var(--font-plus-jakarta)] text-[#e8650a]">
          ...
          >
            ...
            >
              <div className="w-10 h-10 rounded-lg bg-[#1a5c38]/10 flex items-center justify-center">
                <FlaskConical className="w-5 h-5 text-[#1a5c38]" />
              </div>
              <div>
                <div className="text-xs text-[#6b7280]">Active R&amp;D Projects</div>
                <div className="text-xl font-bold font-[family-name:var(--font-plus-jakarta)] text-[#e8650a]">50+</div>
              </div>
            </motion.div>
