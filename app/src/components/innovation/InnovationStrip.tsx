...
const items = [
  { icon: Microscope, title: "Science-Driven", sub: "Every solution backed by rigorous testing" },
  { icon: Lightbulb, title: "Problem Solvers", sub: "We tackle your toughest ingredient challenges" },
  { icon: Rocket, title: "Fast to Market", sub: "From concept to production-ready formula" },
];
